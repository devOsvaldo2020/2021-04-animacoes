if (window.location.pathname.indexOf('/debug/') < 0) {
    ...
    const twitterStyle = document.createElement('style');
    ...
    const twitterPath = "https://twitter.com/";
    const twitterLink = document.createElement('a');
    twitterLink.classList="twitterLink"
    twitterLink.addEventListener('click', () => {
        window.open(twitterPath, '_top');
    })
  
    const twitterIcon = document.createElement('img');
    twitterIcon.classList="twitterIcon"
    twitterIcon.src='/img/twitterLogo4.png';
